...
export default function NewShiftPage() {
  ...
  const [allOperators, setAllOperators] = useState<User[]>([]); // Store all operators (unfiltered)
  const [operators, setOperators] = useState<User[]>([]); // Filtered operators based on date
